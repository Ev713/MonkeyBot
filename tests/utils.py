...
def measure_efficiency(sim_config, timeout=30.0, test=False):
...
def objective(trial):
    ...
    sim_config = SimConfig(
        **static,
        ...
        rotation_speed=trial.suggest_float("twist_speed", 0.5, 3.0),
    ...
    score = measure_efficiency(sim_config, timeout=10.0)
